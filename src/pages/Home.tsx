...
export default function Home() {
  ...
  return (
    <Layout>
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-primary-600 via-medical-600 to-security-600 text-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center animate-fade-in">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 animate-slide-up">
              Muhammad Sobri Maulana
            </h1>
            <p className="text-xl md:text-2xl mb-4 text-primary-100 animate-slide-up" style={{ animationDelay: '0.1s' }}>
              {profile.title}
            </p>
            <p className="text-lg mb-8 text-primary-100 max-w-3xl mx-auto animate-slide-up" style={{ animationDelay: '0.2s' }}>
              {profile.tagline}
            </p>
